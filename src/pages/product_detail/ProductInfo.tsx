  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row items-center gap-4">
        <div className="flex items-center w-[100px] md:w-[123px] h-[54px] border-2 rounded-xl">
          <button
        ...
        <button className="w-full md:w-[205px] h-[44px] md:h-[54px] border border-black rounded-2xl hover:bg-gray-100">
          Add To Cart
        </button>
        <button className="w-full md:w-[205px] h-[44px] md:h-[54px] border border-black rounded-2xl hover:bg-gray-100">
          +Compare
